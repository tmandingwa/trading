...
# === Email alerts ===
EMAIL_ALERTS_ENABLED = os.getenv("EMAIL_ALERTS_ENABLED", "0") == "1"
...
ALERT_TO_EMAIL = os.getenv("ALERT_TO_EMAIL", "")  # usually same as SMTP_USER
ALERT_FROM_EMAIL = os.getenv("ALERT_FROM_EMAIL", "")  # usually same as SMTP_USER
